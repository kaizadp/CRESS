...
icp_summary %>% 
  filter(extraction == "A: DTPA" & 
           group == "cations") %>% 
  ggplot(aes(x = soil_name, y = ugg, fill = extraction))+
...
icp_processed %>% 
  filter(extraction == "A: DTPA" & 
           group == "cations") %>% 
  ggplot(aes(x = sample_ID, y = ug_g, fill = extraction))+
  geom_bar(stat = "identity")+
  labs(title = "cations")+
  facet_wrap(~analyte, scales = "free_y")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
icp_processed %>% 
  filter(extraction == "A: DTPA" & 
           group == "cations") %>% 
  ggplot(aes(x = sample_ID, y = ppb_blank_corr/1000, fill = extraction))+
  geom_bar(stat = "identity")+
  labs(title = "cations")+
  facet_wrap(~analyte, scales = "free_y")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
icp_processed %>% 
  filter(extraction == "A: DTPA" & 
           group == "REEs") %>% 
  ggplot(aes(x = sample_ID, y = ppb_blank_corr, fill = extraction))+
  geom_bar(stat = "identity")+
  labs(title = "REEs")+
  facet_wrap(~analyte, scales = "free_y")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

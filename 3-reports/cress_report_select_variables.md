...
![](cress_report_select_variables_files/figure-gfm/dtpa-1.png)<!-- -->

### Sequential extraction (soil sequence)

![](cress_report_select_variables_files/figure-gfm/soil_sequence-1.png)<!-- -->

### Sequential extraction (AMD sequence)

![](cress_report_select_variables_files/figure-gfm/amd_sequence-1.png)<!-- -->

### Sequential extraction (Tessier sequence)

![](cress_report_select_variables_files/figure-gfm/tessier_sequence-1.png)<!-- -->
...
![](cress_report_select_variables_files/figure-gfm/percent_soil_sequence-1.png)<!-- -->

### Sequential extraction (AMD sequence)

![](cress_report_select_variables_files/figure-gfm/percent_amd_sequence-1.png)<!-- -->

### Sequential extraction (Tessier sequence)

![](cress_report_select_variables_files/figure-gfm/percent_tessier_sequence-1.png)<!-- -->

------------------------------------------------------------------------

# XRF analysis

![](cress_report_select_variables_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
